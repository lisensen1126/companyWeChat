<template class="inviteEvalution font-PC">
  <div class="content">
    <div class="qr-box" id="targetDom">
...
import Api from "@/api/inviteEvaluationApi";
import html2canvas from "html2canvas";
import AppConfig from "../../app.config.js";

export default {
  name: "inviteEvalution",
  component: {},
  data() {
    return {
