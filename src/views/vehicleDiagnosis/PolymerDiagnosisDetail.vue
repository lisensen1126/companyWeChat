    ...
    <div class="record-info">
      <div v-for="(step, findex) in current.category" :key="findex" class="diagnosis-step">
        ...
        <div v-for="(item, sindex) in step.category_item" :key="sindex" class="diagnosis-item">
          ...
          <div class="diagnosis-point-name jiancedian font-10">检测点</div>
          ...
          <div
            class="diagnosis-point-name font-10"
            v-if="item.exception && item.exception.length > 0"
          >异常问题</div>
          <div
            class="diagnosis-line font-10"
          ...
          ></div>
          <div class="diagnosis-point-name font-10" v-if="item.technician_comment">技师备注</div>
