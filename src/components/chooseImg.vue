	...
	<div class="UploadImgXCY">
		<div class="imgLoop">
			<div class="imgBox" v-for="(item,index) in imgArr" :key="index">
				...
				<img class="clear" @click="deleteImg(index)" src="../assets/delete-image.png">
			</div>

			<label class="uploader_box" for="logimg" v-show="limit&&imgArr.length<limit">
				<input type="file" id="logimg" accept="image/*" @change="onRead">
				<img class="clickIcon" src="../assets/application/camera.png">
			</label>
